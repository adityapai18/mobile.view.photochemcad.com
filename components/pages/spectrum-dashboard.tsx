              ...
              {selectedSpectra.map((item) => (
                <View key={`${item.compound.id}-${item.type}`} style={styles.selectedItem}>
                  <View style={styles.selectedItemContent}>
                    <ThemedText style={styles.selectedCompoundName} numberOfLines={1} ellipsizeMode="tail">
                      {item.compound.name}
                    </ThemedText>
          ...
          >
            ...
            >
              ...
              <ThemedText style={styles.manageButtonText}>
                Create spectra{distributions.length > 0 ? ` (${distributions.length})` : ''}
              </ThemedText>
            </TouchableOpacity>
            ...
            >
              ...
              <ThemedText style={styles.manageButtonText}>
                Upload spectrum{uploadedSpectra.length > 0 ? ` (${uploadedSpectra.length})` : ''}
              </ThemedText>
            </TouchableOpacity>
          </ScrollView>
          <ScrollView
            horizontal
            showsHorizontalScrollIndicator={false}
            contentContainerStyle={[styles.modulesRow, styles.modulesRowSecond]}
            style={styles.modulesScrollView}
          >
            {CALCULATION_MODULES.map((m) => (
              ...
              >
                <ThemedText style={styles.moduleButtonText} numberOfLines={2}>
                  {m.title}
                </ThemedText>
              </TouchableOpacity>
            ))}
